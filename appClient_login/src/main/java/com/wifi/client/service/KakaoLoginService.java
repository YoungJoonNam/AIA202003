...
public class KakaoLoginService {
	...
	//private final static String REDIRECT_URI_LOGIN = "http://ec2-54-180-89-108.ap-northeast-2.compute.amazonaws.com:8080/login";
	
	// 로그아웃 리다이렉트 uri
	private final static String REDIRECT_URI_LOGOUT = "http://localhost:8081/logout";
	//private final static String REDIRECT_URI_LOGOUT = "http://ec2-54-180-89-108.ap-northeast-2.compute.amazonaws.com:8080/logout";
	...
	public String getLogoutUrl(HttpSession session) {
		...
		String logoutUrl = "https://kauth.kakao.com/oauth/logout?"
						 + "client_id=" + CLIENT_ID
						 + "&logout_redirect_uri=" + REDIRECT_URI_LOGOUT;
