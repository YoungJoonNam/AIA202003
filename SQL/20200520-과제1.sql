...
;
--
--19. 입사일을 년도는 2자리(YY), 월은 숫자(MON)로 표시하고 요일은 
--약어 (DY)로 지정하여 출력하시오.
select to_char(hiredate,'YY/MM DY')
from emp
;
--
--20. 올해 몇 칠이 지났는지 출력하시오. 현재날짜에서 올해 1월 1일을 
--뺀 결과를 출력하고 TO_DATE 함수를 사용하여 데이터 형을 일치 시키시오.

select sysdate - to_date(20200101,'YY/MM/DD')
from dual
;
--
--21. 사원들의 상관 사번을 출력하되 상관이 없는 사원에 대해서는 NULL 값 
--대신 0으로 출력하시오.
--
select nvl(mgr,0)
from emp
...
;
--
--28. 직급별 사원의 최저 급여를 출력하시오. 관리자를 알 수 없는 사원의 
--최저 급여가 2000 미만인 그룹은 제외시키고 결과를 급여에 대한 
--내림차순으로 정렬하여 출력하시오.
--
select job,min(sal)
from emp
...
--평균 급여를 출력하시오. 평균 급여는 소수점 둘째 자리로 반올림 하시오.
--
...
--모든 사원의 평균 급여를 출력하시오. 평균 급여는 정수로 반올림 
--하시오. DECODE 사용.
--
